...
- Enh #15: Special data provider `Yiisoft\Db\ElasticSearch\ActiveDataProvider` created (klimov-paul)
...
- Enh #2002: Added filterWhere() method to Yiisoft\Db\ElasticSearch\Query to allow easy addition of search filter conditions by ignoring empty search fields (samdark, cebe)
